...
import { DashboardV3 as Dashboard } from '@/pages/dashboard/DashboardV3'
import { AccountsV2 as Accounts } from '@/pages/accounts/AccountsV2'
import { Items } from '@/pages/items/Items'
import { OrdersV2 as Orders } from '@/pages/orders/OrdersV2'
